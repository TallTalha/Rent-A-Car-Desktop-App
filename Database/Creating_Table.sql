...
USE RentACarDatabase
ALTER TABLE Modeller_ve_Siniflar 
ALTER COLUMN Fiyat int NOT NULL

ALTER TABLE Takip_Formlarý
ALTER COLUMN Hizmet_Bedeli int not null

SELECT * FROM Modeller_ve_Siniflar

ALTER TABLE Musteriler
ADD Dogum_Yili int NOT NULL

ALTER TABLE Takip_Formlarý
ADD Zaman_Damgasi DATE not null

ALTER TABLE Takip_Formlarý
ALTER COLUMN Alis_Saati nvarchar(10) not null

ALTER TABLE Takip_Formlarý
ALTER COLUMN Ýade_Saati nvarchar(10) not null

ALTER TABLE Takip_Formlarý
ALTER COLUMN Zaman_Damgasi nvarchar(25) not null
...
CREATE TABLE Musteriler ( -- EN: Customers
	Musteri_ID int IDENTITY(10000,1) not null, -- EN: Customer_ID 10000,10001...
	TCKN  nvarchar(11) not null, --EN: Citizenship_Number
	Musteri_Adi nvarchar(25) not null, -- EN: Customer_Name
	Musteri_Soyadi nvarchar(15) not null, -- EN: Customer_LastName
	Musteri_Sifre nvarchar(20) not null, -- EN: Customer_Password
	Musteri_Telefon nvarchar(10) not null, -- EN: Customer_PhoneNumber
	Dogum_Yili int NOT NULL,
	PRIMARY KEY(Musteri_ID,TCKN)
)

DROP TABLE Takip_Formlarý
CREATE TABLE Takip_Formlarý ( -- EN: Tracking_Forms
	Takip_ID int IDENTITY(1,1) PRIMARY KEY, -- EN: Tracking_ID
	Musteri_ID int not null,
	Musteri_TCKN nvarchar(11) not null,
	Plaka nvarchar(8)  FOREIGN KEY REFERENCES Arabalar(Plaka) not null,
	Alis_Tarihi DATE not null, -- EN : Purchase_Date
	Ýade_Tarihi DATE not null, -- EN: Return_Date
	Hizmet_Bedeli int not null, -- EN: Service_Fee
	FOREIGN KEY (Musteri_ID, Musteri_TCKN) REFERENCES Musteriler (Musteri_ID,TCKN)
)

SELECT * FROM Musteriler

DELETE FROM Musteriler where Musteri_ID = 10000
